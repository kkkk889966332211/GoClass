...
public interface UserRepository extends JpaRepository<User,Integer> {
    ...
    @Modifying
    @Query(value = "UPDATE user SET user_name = :user_name WHERE user_id =:user_id",nativeQuery = true)
    void UpdateUserName(@Param("user_id") int user_id,@Param("user_name") String user_name);
    ...
    void UpdateMotto(@Param("user_id") int user_id,@Param("motto") String motto);

    @Modifying
    @Query(value = "UPDATE user SET note = :note WHERE user_id =:user_id",nativeQuery = true)
    void UpdateNote(@Param("user_id") int user_id,@Param("note") String note);
